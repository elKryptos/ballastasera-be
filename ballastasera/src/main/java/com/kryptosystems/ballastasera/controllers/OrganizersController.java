...
import static com.kryptosystems.ballastasera.utilities.RestConstants.ORGANIZERS;
...
public class OrganizersController {
    ...
    private static final String GET_BY_SLUG = "/{slug}";
    private static final String GET_MY_ORGANIZERS = "/me";
    ...
    @GetMapping(GET_ORGANIZERS_LIST)
    ...
    @GetMapping(GET_ORGANIZER_EVENTS)
    ...
    @GetMapping(GET_ORGANIZER_VENUES)
    ...
    @GetMapping(GET_ORGANIZER_EVENT_SERIES)
